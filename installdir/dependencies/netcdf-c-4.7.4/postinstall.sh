...
if [ "x$DOAUTOTOOL" = "xTRUE" ]; then
    ...
    if [ "x$DOACTION" = "xbuild" ]; then
        ...
        LIBS="-lhdf5_hl -lhdf5 -lm -ldl -lz " CFLAGS="-I/home/gengz/gpu-v2/exageostat/installdir/include" LDFLAGS="-L/home/gengz/gpu-v2/exageostat/installdir/lib" ./configure --prefix=/home/gengz/gpu-v2/exageostat/installdir $STATIC_BUILD $SHARED_BUILD
        LIBS="-lhdf5_hl -lhdf5 -lm -ldl -lz " make
        LIBS="-lhdf5_hl -lhdf5 -lm -ldl -lz " make check
    fi
